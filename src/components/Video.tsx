                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            src="https://github.com/ashley-nascimento.png" 
                            alt="" 
                            />
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Ashley Nascimento</strong>
                                <span className="text-gray-200 text-sm block">FrontEnd Developer</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4">
                        <a href="" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold gap-2 uppercase justify-center hover:bg-green-700 transition-colors">
                            <DiscordLogo size={24} />
